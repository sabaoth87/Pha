...
public class SudokuKeypad extends Dialog{
	protected static final String TAG = "PHA:LANX(Su)" ;
	private final View keys[] = new View[9];
	private View keypad;
	
	private final int useds[];
	private final PHA_PuzzleView puzzleView;
	
public SudokuKeypad(Context context, int useds[], PHA_PuzzleView puzzleView) {
	super(context);
	this.useds = useds;
...
protected void onCreate(Bundle savedInstanceState){
	...
	setTitle(R.string.sudokuSettingsTitle);
